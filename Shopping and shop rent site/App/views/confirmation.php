...
<body>
    ...
    if (referrer.includes("dashboard.php")) {
        redirectTo = "index.php"; // Redirect to index.php if coming from dashboard.php
    } else if (referrer.includes("ItemInfo.php")) {
        redirectTo = "dashboard.php"; // Redirect to dashboard.php if coming from ItemInfo.php
    }
    else if (referrer.includes("customerProf.php")) {
        redirectTo = "index.php"; // Redirect to dashboard.php if coming from ItemInfo.php
    } else {
